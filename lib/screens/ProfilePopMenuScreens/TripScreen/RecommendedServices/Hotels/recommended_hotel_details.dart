...
class RecommendedHotelDetailAndBooking extends StatefulWidget {
  final HotelModel? item;
  final Future<List<HotelModel>>? products;
  final Future<List<HotelReview>>? reviews;
  RecommendedHotelDetailAndBooking({Key? key, this.reviews, this.products, this.item})
      : super(key: key);
  @override
  _RecommendedHotelDetailAndBookingState createState() => _RecommendedHotelDetailAndBookingState();
}

class _RecommendedHotelDetailAndBookingState extends State<RecommendedHotelDetailAndBooking>
          ...
          children: [
            ...
            Column(
              children: [
                ...
                // RoomRecommendedDetailsCard(
                //   products: WebServices.hotelItems(),
                //   item: this.widget.item,
                //   tripItem: this.widget.tripItem
                // ),
                                          ...
                                          CustomBtn(
                                            ...
                                            onPressed: () async {
                                              ...
                                              Navigator.of(context).pushReplacement(
                                                MaterialPageRoute(
                                                    builder: (context) =>
                                                        RecommendedHotelDetailAndBooking(
                                                          products: WebServices
                                                              .hotelItems(),
                                                          reviews: WebServices
                                                              .hotelReviewItem(
