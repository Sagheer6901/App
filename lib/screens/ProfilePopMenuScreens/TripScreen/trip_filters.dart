...
List selectedTripFilters = [];

class TripFilters extends StatefulWidget {
  ...
  @override
  _TripFiltersState createState() => _TripFiltersState();
}

class _TripFiltersState extends State<TripFilters> {
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      // TripFilters.selectFilters.add("5");
      TripFilters.selectFilters.add("Tour the swat");
      print("trips ${TripFilters.selectFilters}");
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            print("guides in ${TripFilters.selectFilters}");
                            selectedTripFilters = TripFilters.selectFilters;
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) =>TripList()),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return FilterCard(item: widget.items![index], terms: WebServices.filterTripTerms("${widget.items![index].id}"),);
      },
    );
  }
}
        ...
        return Row(children: [
          ...
          Expanded(child: Container(
            ...
            child: ElevatedButton(
              ...
              selectedTripFilters.contains("${widget.items![index].termName}")?MaterialStateProperty.all<Color>(AppConfig.carColor):MaterialStateProperty.all<Color>(Colors.white),
                  shape: MaterialStateProperty.all<
              ...
              onPressed:(){
                setState(() {
                  TripFilters.selectFilters.contains("${widget.items![index].termName}")?
                  TripFilters.selectFilters.remove("${widget.items![index].termName}"):selectedTripFilters.add("${widget.items![index].termName}") ;
                });
