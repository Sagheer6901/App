...
List selectedGuideFilters = [];

class GuideFilters extends StatefulWidget {
  ...
  @override
  _GuideFiltersState createState() => _GuideFiltersState();
}

class _GuideFiltersState extends State<GuideFilters> {
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            //   context,
                            //   MaterialPageRoute(
                            //       builder: (context) => GuideList(                                     products: WebServices.tourGuideItems(),
                            //       )),
                            // );
                          },
                          style: ButtonStyle(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            print("guides in ${GuideFilters.selectFilters}");
                            selectedGuideFilters = GuideFilters.selectFilters;
                            Navigator.push(
                              context,
                              MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return FilterCard(item: widget.items![index], terms: WebServices.filterGuideTerms("${widget.items![index].id}"),);
      },
    );
  }
}
        ...
        return Row(children: [
          ...
          Expanded(child: Container(
            ...
            child: ElevatedButton(
              ...
              selectedGuideFilters.contains("${widget.items![index].termName}")?MaterialStateProperty.all<Color>(AppConfig.carColor):MaterialStateProperty.all<Color>(Colors.white),
                  shape: MaterialStateProperty.all<
              ...
              onPressed:(){
                setState(() {
                  GuideFilters.selectFilters.contains("${widget.items![index].termName}")?
                  GuideFilters.selectFilters.remove("${widget.items![index].termName}"):selectedGuideFilters.add("${widget.items![index].termName}") ;
                });
