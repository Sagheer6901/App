...
class CarFilters extends StatefulWidget {
  ...
  @override
  _CarFiltersState createState() => _CarFiltersState();
}

class _CarFiltersState extends State<CarFilters> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      CarFilters.selectFilters.add("Prado TB");
      print("cars ${CarFilters.selectFilters}");
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            print("cars in ${CarFilters.selectFilters}");
                            selectedCarFilters = CarFilters.selectFilters;
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => VehicleList(  )),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return FilterCard(item: widget.items![index], terms: WebServices.filterCarTerms("${widget.items![index].id}"),);
      },
    );
  }
}
        ...
        return Row(children: [
          ...
          Expanded(child: Container(
            ...
            child: ElevatedButton(
              ...
              selectedCarFilters.contains("${widget.items![index].termName}")?MaterialStateProperty.all<Color>(AppConfig.carColor):MaterialStateProperty.all<Color>(Colors.white),
                  shape: MaterialStateProperty.all<
              ...
              onPressed:(){
                setState(() {
                  CarFilters.selectFilters.contains("${widget.items![index].termName}")?
                  CarFilters.selectFilters.remove("${widget.items![index].termName}"):selectedCarFilters.add("${widget.items![index].termName}") ;
                });
